...
![Mozilla的Geoko渲染引擎主流程](./images/browser-4.png)
```
...
![示例html树的构建过程](./images/browser-11.png)
...
![Firefox样式上下文树](./images/browser-14.png)
...
![Firefox样式上下文树](./images/browser-14-1.png)
...
Webkit中，并没有规则树，匹配的声明会被遍历四次，先是应用非important的高优先级属性
